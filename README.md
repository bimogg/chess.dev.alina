...
5. **Понятный roadmap** — Pro и платежи описаны как следующий этап, без оверклеймов
...
- Платежи пока не реализованы (roadmap)
...
- **Stripe-интеграция** для Pro-подписки (сейчас покупка не реализована)
- **Усиление realtime-инфры** (валидация, права, наблюдатели)
